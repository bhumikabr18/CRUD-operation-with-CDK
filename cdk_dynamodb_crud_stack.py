...
class DynamoDbCrudStack(Stack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        create_lambda = lambda_.Function(
            ...
            handler="create_student.handler",  # Replace with your Lambda function handler
            code=lambda_.Code.from_asset("cdk-dynamodb-crud"),  # Update with the path to your Lambda function code
            environment={
        ...
        read_lambda = lambda_.Function(
            ...
            "ReadStudentLambda",
            runtime=lambda_.Runtime.PYTHON_3_9,
            handler="read_student.handler",  # Replace with your Lambda function handler
            code=lambda_.Code.from_asset("cdk-dynamodb-crud"),  # Update with the path to your Lambda function code
            environment={
        ...
        update_lambda = lambda_.Function(
            ...
            "UpdateStudentLambda",
            runtime=lambda_.Runtime.PYTHON_3_9,
            handler="update_student.handler",  # Replace with your Lambda function handler
            code=lambda_.Code.from_asset("cdk-dynamodb-crud"),  # Update with the path to your Lambda function code
            environment={
                "TABLE_NAME": student_table.table_name
            }
        ...
        delete_lambda = lambda_.Function(
            ...
            "DeleteStudentLambda",
            runtime=lambda_.Runtime.PYTHON_3_9,
            handler="delete_student.handler",  # Replace with your Lambda function handler
            code=lambda_.Code.from_asset("cdk-dynamodb-crud"),  # Update with the path to your Lambda function code
            environment={
                "TABLE_NAME": student_table.table_name
            }
    ...
    handler="create_student.lambda_handler",
    code=lambda_.Code.from_asset("cdk-dynamodb-crud"),
    timeout=Duration.seconds(10)  # Increase timeout to 10 seconds or more
)
        ...
        students_resource.add_method("POST", apigateway.LambdaIntegration(create_lambda, timeout=Duration.seconds(10)))  # POST /students (Create)
